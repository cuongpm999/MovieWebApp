				...
				<div class="row">
					<div class="col-md-3 poster">
						...
						<div class="xem-trailer">
							<a href="/movie_details/watch_odd_movie/${see_movie.seo }">XEM
								PHIM</a>
						</div>
					</div>
				...
				<div id="download-link-list">
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								<td>Server Quốc tế</td>
								<td>Full</td>
								<td><a
									href="https://drive.google.com/uc?export=download&id=${see_movie.posterVideoPhims.get(1).id_google_drive }"
									download>Download Full (Vietsub)</a></td>
							</tr>
