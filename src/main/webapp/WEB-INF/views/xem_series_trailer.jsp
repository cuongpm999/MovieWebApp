			...
			<div class="chi-tiet">
				<div class="row">
					<div class="col-md-3 poster">
						<img
							src="https://drive.google.com/uc?export=view&id=${see_trailer.posterVideoPhims.get(0).id_google_drive }"
							alt="movie">
						<div class="xem-trailer">
							<a href="/movie_details/watch_series_movie/${see_trailer.seo }">XEM PHIM</a>
						</div>
					</div>
					<div class="col-md-9 noi-dung">
						<h4>XEM PHIM ${see_trailer.ten_phim_tiengviet }</h4>
						<p class="en">${see_trailer.ten_phim_tienganh }</p>
						<p class="content-movie scrollbar" id="style-1">
							${see_trailer.noi_dung_phim }</p>
					</div>
				</div>
				<iframe width="100%" height="400"
					src="${see_trailer.trailer }" frameborder="0"
			...
			<div class="binhluan">
				...
				<div style="background-color: rgba(65, 63, 63, 0.678);">
					<div class="fb-comments"
						data-href="https://developers.facebook.com/docs/plugins/comments#configurator/${see_trailer.seo }"
