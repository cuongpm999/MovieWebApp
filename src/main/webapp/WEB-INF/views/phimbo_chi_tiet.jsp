		...
		<div class="col-md-9 phim">
			<div class="chi-tiet">
				<div class="row">
					<div class="col-md-6 poster">
						...
						<ul class="btn-block list-unstyled">
							<li class="item"><a id="btn-film-download"
								...
								href="/movie_details/download_series_movie/${movie.seo }">Download</a></li>
							<li class="item"><a id="btn-film-trailer"
								class="btn btn-primary btn-film-trailer"
								href="/movie_details/watch_series_trailer/${movie.seo }">Trailer</a></li>
							<li class="item"><a id="btn-film-watch"
								class="btn btn-danger"
								href="/movie_details/watch_series_movie/${movie.seo }">Xem
									phim</a></li>
						</ul>
					</div>
					<div class="col-md-6 infor-movie">
						...
						<dl class="movie-dl scrollbar" id="style-1">
							...
							<br>
							<dt class="movie-dt">Số tập:</dt>
							<dd class="movie-dd">${movie.so_tap }</dd>
							<br>
				...
				<div class="noidung">
					...
					<h1 class="my-3"></h1>
					<p id="waypoint_here" class="content-movie">
			...
			<div class="binhluan">
				...
				<div style="background-color: rgba(65, 63, 63, 0.678);">
					<div class="fb-comments"
						data-href="http://128.0.0.1:${movie.seo }"
