...
<body>
	...
	<div id="main" class="container">
		...
		<div class="col-md-9 phim">
			<h2 class="tieude">PHIM BỘ</h2>
			<div class="row">
				<c:forEach var="phimbo" items="${phimbo }">
					<div class="col-md-4">
						<a href="/series_movie_details/${phimbo.seo }"><img src="https://drive.google.com/uc?export=view&id=${phimbo.posterVideoPhims.get(0).id_google_drive }" alt="movie">
						...
						<div class="ten_phim">
							...
							</a> <a class="english" href="/series_movie_details/${phimbo.seo }">${phimbo.ten_phim_tienganh }</a> <span
								class="time">${phimbo.thoi_luong }</span>
						</div>
						<span class="ribbon">${phimbo.chat_luong }-Vietsub | ${phimbo.so_tap }</span>
					</div>
				</c:forEach>
			</div>
			<div class="page-link">
				<a href="javascript:Blog.goPrev('/phim_bo/')"><i class="fas fa-chevron-left"></i></a> <a href="javascript:Blog.goNext('/phim_bo/')"><i
