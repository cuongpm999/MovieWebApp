	...
	<div id="main" class="container">
		...
		<div class="col-md-9 phim">
			<div class="chi-tiet">
				<div class="row">
					<div class="col-md-3 poster">
						...
						<div class="xem-trailer">
							<a href="/movie_details/watch_series_trailer/${see_movie.seo }">XEM
								TRAILER</a>
						</div>
					</div>
				...
				<iframe class="play-video" id="videoId" src="https://drive.google.com/file/d/${see_movie.posterVideoPhims.get(1).id_google_drive }/preview" width="100%" allowfullscreen="true" allow-popups="none"></iframe>

				<div class="list-phimbo" style="text-align: left;">
					<h6 class="server-name">Chọn tập phim</h6>
					<ul>
						<c:set var="nFilters" value="${1 }" scope="request" />
						<c:forEach var="videoAttachment"
							items="${see_movie.posterVideoPhims }" varStatus="loop">
							<c:if test="${loop.index > 0}">
								<li id="btn-phim-${nFilters}"
									onclick="Blog.displayPhimBo('${videoAttachment.id_google_drive }')">${nFilters }</li>
			...
			<div class="binhluan">
				...
				<div style="background-color: rgba(65, 63, 63, 0.678);">
					<div class="fb-comments"
						data-href="https://developers.facebook.com/docs/plugins/comments#configurator/${see_movie.seo }"
