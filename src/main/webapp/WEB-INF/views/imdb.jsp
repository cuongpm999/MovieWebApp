...
<body>
	...
	<div id="main" class="container">
		...
		<div class="col-md-9 phim">
			<h2 class="tieude">PHIM LẺ IMDB</h2>
			<div class="row">
				<c:forEach var="imdbMovie" items="${imdbMovie }">
					<div class="col-md-4">
						<a href="/odd_movie_details/${imdbMovie.seo }"><img
							src="https://drive.google.com/uc?export=view&id=${imdbMovie.posterVideoPhims.get(0).id_google_drive }"
							alt="movie">
							<div class="movie-action-icon">
								<i class="far fa-play-circle"></i>
							</div> </a>
						<div class="ten_phim">
							<a href="/odd_movie_details/${imdbMovie.seo }">
								<h6 class="font-weight-bold">${imdbMovie.ten_phim_tiengviet }</h6>
							</a> <a class="english" href="/odd_movie_details/${imdbMovie.seo }">${imdbMovie.ten_phim_tienganh }</a>
							<span class="time">${imdbMovie.thoi_luong }</span>
						</div>
						<span class="ribbon">${imdbMovie.chat_luong }-Vietsub</span>
					</div>
				</c:forEach>
			</div>
		</div>
